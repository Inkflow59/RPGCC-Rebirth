...
public abstract class GLRenderer
{
    ...
    public abstract void setTransformation (float scalex, float scaley, int posx, int posy, int hotspotx, int hotspoty, float angle);

    public abstract void setTransformationMatrix (float[] array);
    ...
    public abstract void setBlendMode (boolean on_mode);

    public abstract void setCurrentView(int currentWidth, int currentHeight, float scaleX, float scaleY);
	...
	public abstract void setSurfaceTextureAtIndex(ITexture image, String var_name, int index);
    ...
    public abstract void renderBlitFull(ITexture image, boolean resampling);
    ...
    public abstract void setBackgroundUse(int shaderIndex);
}
