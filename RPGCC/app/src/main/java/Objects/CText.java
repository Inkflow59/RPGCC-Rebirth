...
public class CText extends CObject
{
	...
	public void setTextShadowXtras(boolean enabled, float radius, float dx, float dy, int color)
	{
		if(textSurface != null)
		{
			textSurface.enableShadow(enabled);
			textSurface.setShadowValues(radius, dx, dy, color);
			rsTextChange = true;
		}
	}
}
