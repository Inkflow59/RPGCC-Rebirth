 ...
 */
    public int checkOrCreateEffectIfNeeded(CRunApp app, COI oi)
    {
        if(bkdEffect == null)
        {
            bkdEffect = new CEffectEx(app);
            if (bkdEffect.initialize(oi.oiIndexEffect, oi.oiInkEffectParam))
            {
                fillEffectData(oi);
    ...
    {
        if(oiPtr.oiEffectOffset != 0 && bkdEffect != null && oiPtr.oiEffectData != null)
        {
