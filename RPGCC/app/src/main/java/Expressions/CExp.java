...
//              exp = new EXP_GETCHANNELFREQ();
                break;
            case ((12 << 16) | 0xFFFE):		// EXP_GETCHANNELSNDNAME
...
//              exp = new EXP_GETFRAMEBKDCOLOR();
                break;
            case ((16 << 16) | 0xFFFD):		// EXPL_FRAMEALPHACOEF
//              exp = new EXP_FRAMEALPHACOEF();
                break;
            case ((17 << 16) | 0xFFFD):		// EXP_FRAMERGBCOEF
//              exp = new EXP_FRAMERGBCOEF();
                break;
            case ((18 << 16) | 0xFFFD):		// EXPL_FRAMEEFFECTPARAM
                exp = new EXP_FRAMEEFFECTPARAM();
                break;
...
//              exp = new EXP_CRENUMBERALL();
                break;
            case ((1 << 16) | 0xFFFB):		// EXP_LASTFIXEDVALUE
...
//                      exp=new EXP_EXTHEIGHT();
					...
					case (42<< 16):		//	EXTGETMASS
						//p=new EXP_EXTGETMASS();
						break;
					case (43<< 16):		//	EXP_EXTGETANGULARVELOCITY
						//p=new EXP_EXTGETANGULARVELOCITY();
						break;
					case (44<< 16):		//	EXTGETNAME
						//p=new EXP_EXTGETNAME();
						break;
					case (45 << 16):
						//p = new EXP_NUMBEROFSELECTED();
						break;
					case (46 << 16):
						//p = new EXP_EXTINSTANCEDATA();
						break;
                    default:
        ...
        if (exp != null)
        {
            ...
            Log.Log("Missing expression! c="+Integer.toHexString(c));
        }
