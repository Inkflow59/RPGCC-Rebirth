...
public class ES1Renderer extends GLRenderer
{
    ...
    @Override
    public void setTransformation (float scalex, float scaley, int posx, int posy, int hotspotx, int hotspoty, float angle) {
    }

    @Override
    public void setTransformationMatrix (float[] array) {
    }
    ...
    public void setCurrentView(int currentWidth, int currentHeight, float scaleX, float scaleY) {
    ...
    @Override
    public void setBlendMode (boolean on_mode) {
        if(on_mode)
        {
    ...
    public void setSurfaceTextureAtIndex(ITexture image, String var_name, int index) {
    }
    ...
    public void setBackgroundUse(int shaderIndex) {
    }
   ...
   @Override
    ...
    public Bitmap drawBitmap(int x, int y, int w, int h, Bitmap.Config config) {
        ...
        int gl_error = GLES11.glGetError();
        if(gl_error != GLES11.GL_NO_ERROR)
    ...
    @Override
    public void renderBlitFull(ITexture image, boolean useResampling) {
    	renderImage(image, useResampling, 0, 0, image.getWidth(), image.getHeight(), 0, 0);
    }
